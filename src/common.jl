...
export AF_AUTO_OTSU_THRESHOLD, AF_BACKEND_CPU, AF_BACKEND_CUDA, AF_BACKEND_DEFAULT, AF_BACKEND_OPENCL
export AF_BINARY_ADD, AF_BINARY_MAX, AF_BINARY_MIN, AF_BINARY_MUL, AF_COLORMAP_BLUE, AF_COLORMAP_COLORS
export AF_COLORMAP_DEFAULT, AF_COLORMAP_HEAT, AF_COLORMAP_MOOD, AF_COLORMAP_RED, AF_COLORMAP_SPECTRUM
...
export AF_INTERP_LINEAR_COSINE, AF_INTERP_LOWER, AF_INTERP_NEAREST, AF_LSAD, AF_LSSD, AF_MANUAL_THRESHOLD
export AF_MARKER_CIRCLE, AF_MARKER_CROSS, AF_MARKER_NONE, AF_MARKER_PLUS, AF_MARKER_POINT, AF_MARKER_SQUARE
export AF_MARKER_STAR, AF_MARKER_TRIANGLE, AF_MAT_BLOCK_DIAG, AF_MAT_CONJ, AF_MAT_CTRANS, AF_MAT_DIAG_UNIT
export AF_MAT_LOWER, AF_MAT_NONE, AF_MAT_ORTHOG, AF_MAT_POSDEF, AF_MAT_SYM, AF_MAT_TRANS, AF_MAT_TRI_DIAG
export AF_MAT_UPPER, AF_MOMENT_FIRST_ORDER, AF_MOMENT_M00, AF_MOMENT_M01, AF_MOMENT_M10, AF_MOMENT_M11
export AF_NCC, AF_NORM_EUCLID, AF_NORM_MATRIX_1, AF_NORM_MATRIX_2, AF_NORM_MATRIX_INF, AF_NORM_MATRIX_L_PQ
export AF_NORM_VECTOR_1, AF_NORM_VECTOR_2, AF_NORM_VECTOR_INF, AF_NORM_VECTOR_P, AF_PAD_SYM, AF_PAD_ZERO
export AF_RANDOM_ENGINE_DEFAULT, AF_RANDOM_ENGINE_MERSENNE, AF_RANDOM_ENGINE_MERSENNE_GP11213, AF_RANDOM_ENGINE_PHILOX
export AF_RANDOM_ENGINE_PHILOX_4X32_10, AF_RANDOM_ENGINE_THREEFRY, AF_RANDOM_ENGINE_THREEFRY_2X32_16, AF_RGB
export AF_SAD, AF_SHD, AF_SSD, AF_STORAGE_COO, AF_STORAGE_CSC, AF_STORAGE_CSR, AF_STORAGE_DENSE, AF_SUCCESS
export AF_YCC_2020, AF_YCC_601, AF_YCC_709, AF_YCbCr, AF_ZNCC, AF_ZSAD, AF_ZSSD, afDevice, afHost, af_array
export af_backend, af_binary_op, af_border_type, af_canny_threshold, af_colormap, af_connectivity, af_conv_domain
...
const AF_MANUAL_THRESHOLD = (UInt32)(0)
const AF_AUTO_OTSU_THRESHOLD = (UInt32)(1)
