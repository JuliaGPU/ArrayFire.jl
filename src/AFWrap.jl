...
af_upper(a::AFMatrix) = icxx"af::upper($a);"
af_lower(a::AFMatrix) = icxx"af::lower($a);"
...
af_stdev(a::AFAbstractArray) = icxx"af::stdev($a);"
af_stdev(a::AFAbstractArray, b::Integer) = icxx"af::stdev($a,$b);"
af_var(a::AFAbstractArray) = icxx"af::var($a);"
