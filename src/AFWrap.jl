...
const AF_CONV_DEFAULT = icxx"AF_CONV_DEFAULT;"

af_convolve(a::AFAbstractArray, b::AFAbstractArray, mode=AF_CONV_DEFAULT) = icxx"af::convolve($a,$b,$mode);"
af_convolve1(a::AFAbstractArray, b::AFAbstractArray) = icxx"af::convolve1($a,$b);"
af_convolve2(a::AFAbstractArray, b::AFAbstractArray) = icxx"af::convolve2($a,$b);"
af_convolve3(a::AFAbstractArray, b::AFAbstractArray) = icxx"af::convolve3($a,$b);"
...
af_colorspace(a::AFAbstractArray, b::Cxx.CppEnum{:af_cspace_t},c::Cxx.CppEnum{:af_cspace_t}) = icxx"af::colorspace($a,$b,$c);"
...
af_window(a::AbstractString) = icxx"af::Window($a);"
af_window(a::Integer, b::Integer, c::AbstractString) = icxx"af::Window($a,$b,$c);"
af_setTitle(a::AFWindow, b::AbstractString) = icxx"$a.setTitle($b);"
af_setImage(a::AFWindow, b::AFAbstractArray, c::AbstractString) = icxx"$a.image($b,$c);"
