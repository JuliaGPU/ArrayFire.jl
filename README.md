...
#Windows
Just downdload the [installer](http://arrayfire.com/download/) (you need to create an account).
Follow the installation steps and make sure that you include the library directory into the PATH variable as adviced by the installer.
Now try:
```julia
Pkg.add("ArrayFire")
Pkg.test("ArrayFire")
